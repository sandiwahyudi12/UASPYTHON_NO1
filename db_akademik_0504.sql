...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Jan 2022 pada 13.34
...
--
-- Struktur dari tabel `tbl_students_0504`
--

CREATE TABLE `tbl_students_0504` (
  `id` int(5) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0504`
--

INSERT INTO `tbl_students_0504` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0504`
--
ALTER TABLE `tbl_students_0504`
  ADD PRIMARY KEY (`id`);
COMMIT;
